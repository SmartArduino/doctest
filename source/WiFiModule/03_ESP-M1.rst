...
The sell information can be visited at our link: M1:  `www.vvdoit.com <http://vvdoit.com/official-doit-10pcspack-mini-ultra-small-size-esp-m1-from-esp8285-wifi-module-serial-wireless-iot-compatible-esp8266-8266-diy-p779628.html>`_, and M2 `www.vvdoit.com <http://vvdoit.com/official-doit-5pcspack-mini-ultra-small-size-esp-m2-esp8285-wifi-module-serial-wireless-diy-iot-compatible-with-esp8266-8266-p779710.html>`_
...
PINs definition of ESP-F can be shown in the following.
 ...
 .. figure:: ../_static/ESP8285Pins.png
    :align: center
    :alt: Pins definition for ESP-M1 Module
    :figclass: align-center

    Pins definition for ESP-M1 Module

 .. figure:: ../_static/ESP8285M2Pins.png
    :align: center
    :alt: Pins definition for ESP-M2 Module
    :figclass: align-center
...
+----+-----+----+---------------------------------------------------------------------+ 
| 9  |IO15 |I/O |GPIO15; MTDO;HSPICS;UART0_RTS,connected registance                   |
+----+-----+----+---------------------------------------------------------------------+ 
| 10 | IO2 |I/O |GPIO2; UART1_TXD                                                     |
+----+-----+----+---------------------------------------------------------------------+ 
...
| 13 | IO5 |I/O |GPIO5                                                                |
+----+-----+----+---------------------------------------------------------------------+ 
| 14 | RXD |I/O |GPIO3; used to build in Flash as UART Rx                             |
+----+-----+----+---------------------------------------------------------------------+ 
| 15 | TXD |I/O |GPIO1; used to build in Flash as UART Tx                             |
+----+-----+----+---------------------------------------------------------------------+ 
| 16 | GND |p   |GND                             |
+----+-----+----+---------------------------------------------------------------------+
...
Shape and size for this module can be shown as follows. Its size is 16mm*24mm*3mm, and the Flash is 4M bytes (32Mbits), together with the following picture.
 ...
 .. figure:: ../_static/ESP8285M1sample.png
    :align: center
    :alt: ESP-M1 Module
    :figclass: align-center
 ...
 .. figure:: ../_static/ESP8285M2sample.png
    :align: center
    :alt: ESP-M2 Module
    :figclass: align-center
...
--------------
 ...
 .. figure:: ../_static/ESP8285Mminimum.png
    :align: center
    :alt: Minimum for ESP-M
    :figclass: align-center
...
.. figure:: ../_static/ESP8285M1antenana.png
    :align: center
    :alt: Connector for the external antenna
    :figclass: align-center
...
.. figure:: ../_static/ESP8285M2S1.png
    :align: center
    :alt: ESP-M S1
    :figclass: align-center
...
.. figure:: ../_static/ESP8285M2S2.png
    :align: center
    :alt: ESP-F S2
    :figclass: align-center
...
.. figure:: ../_static/ESP8285M2S3.png
    :align: center
    :alt: ESP-M S3
    :figclass: align-center
